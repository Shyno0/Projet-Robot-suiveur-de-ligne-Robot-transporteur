...
const unsigned char sensibility = 25;       // Constante - Valeur de la sensibilité entre lumière/ombre
const unsigned char vel1 = (vel2*1.2), vel2 = 150; // Constantes - Valeurs des vitesses prédéfinies
